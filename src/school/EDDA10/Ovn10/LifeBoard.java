...
public class LifeBoard {
    ...
    /**Returns true if there is a individual at biggestIndex row, col, else false.
     * If biggestIndex row, col is outside return false.*/
    ...
    /**Insert the value of val in biggestIndex row, col.*/
